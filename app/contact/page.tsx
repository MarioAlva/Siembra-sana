				...
				<div className="flex flex-col items-center w-[1700px] max-w-full relative">
					...
					<section className="flex justify-center w-full">
						<form action="contact" className="flex flex-col w-[1200px] max-w-full px-12 mb-12">
							...
							<input onChange={(e) => setName(e.currentTarget.value)} className="text-sm w-full py-1 px-2 border border-neutral-600 focus:outline-green-600 focus:outline" value={name} type="text" name="name" id="name" placeholder="Nombre" />							<label className="text-sm text-neutral-600 mt-2" htmlFor="message">Mensaje</label>
							...
							<a href={"mailto:marioantonioalva@gmail.com?subject=Nuevo mensaje de " + name + "&body=" + message} className="cursor-pointer font-bold w-full bg-green-600 py-2 mt-4 rounded text-white focus:outline-2 focus:outline-green-800 flex justify-center items-center" >Enviar</a>
						</form>
					</section>
				</div>
			</main>
